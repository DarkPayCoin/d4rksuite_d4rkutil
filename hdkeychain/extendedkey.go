...
func (k *ExtendedKey) Child(i uint32) (*ExtendedKey, error) {
	...
	parentFP := partutil.Hash160(k.pubKeyBytes())[:4]
...
func (k *ExtendedKey) Address(net *chaincfg.Params) (*partutil.AddressPubKeyHash, error) {
	pkHash := partutil.Hash160(k.pubKeyBytes())
	return partutil.NewAddressPubKeyHash(pkHash, net)
}
