...
import (
	...
	"github.com/particl/partsuite_partutil/coinset"
)

type TestCoin struct {
	TxHash     *chainhash.Hash
	TxIndex    uint32
	TxValue    partutil.Amount
	TxNumConfs int64
}

func (c *TestCoin) Hash() *chainhash.Hash { return c.TxHash }
func (c *TestCoin) Index() uint32         { return c.TxIndex }
func (c *TestCoin) Value() partutil.Amount { return c.TxValue }
...
func NewCoin(index int64, value partutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	...
	testSimpleCoinTxValue0            = partutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = partutil.NewTxFromBytes(testSimpleCoinTxBytes)
